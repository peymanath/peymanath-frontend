				...
				{SkillsList &&
					SkillsList.map(
						({ id, titleFa, titleEn, descriptin, imageUrl, metaData }) => (
							<div key={id} className="flex flex-col justify-between gap-10 bg-white shadow-xl p-3 rounded-lg">
								...
								<div className="flex gap-1 items-start justify-between ">
									<div className="flex gap-2 items-center">
										...
										<span className="text-xl leading-none pt-1">{metaData.recommmendations}</span>
									</div>
									<div className="flex gap-2 items-center">
										<span className="text-xl leading-none pt-1">{metaData.project}</span>
