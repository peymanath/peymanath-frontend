...
export default function Home() {
    return (
        <div className='container'>
            ...
            <div
                ...
                <div className='flex flex-col-reverse items-center justify-center text-center gap-10 lg:flex-row'>
                    <div className='px-6 lg:px-20'>
                        <div className='flex items-center justify-center pa relative bg-black/60 backdrop-blur-lg border border-gray-500/10 p-12 leading-10'>
                            {dataSliderHome}
                        </div>
                    </div>
                </div>
            ...
            <div
                id='skills-me'
                className='relative flex flex-col justify-center gap-10 lg:gap-40 '>
                <p className='flex flex-wrap gap-3 items-center justify-center font-semibold text-2xl lg:text-4xl'>
                    <span>مهارت های</span>
                    <span className='animate-color-text'> پیمان نادری</span>
                </p>
